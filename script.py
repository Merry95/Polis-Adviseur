...
gezinssituatie = st.selectbox("Wat is je werksituatie?", ["In loondienst", "zzp", "Werkloos"])
werkSituatie = st.selectbox("Wat is je werksituatie?", ["Alleen", "samenwonend", "kinderen","huisdieren"])
